...
const Tooltip = ({ children, ...rest }) => (
    ...
    <Tippy className={'bg-white color-black weight-500 size-14 border-gray2 border-radius-6'} {...rest}>{/* Сначала указываются дефолтные свойства, потом {...rest}. Потому что {...rest} переписывает дефолтные свойства своими. */}
        {children}
    </Tippy>
);
